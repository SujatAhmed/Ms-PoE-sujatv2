...
class MsPoELlamaRotaryEmbedding(nn.Module):
    def __init__(self, dim, min_cratio=1, max_cratio=3, num_heads=32, max_position_embeddings=2048, base=10000, device=None):
        ...
        self._set_cos_sin_cache_power_bowl(
    ...
    def _set_cos_sin_cache_quadratic_bowl(
        ...
        """
        print(f"from quadratic bowl sampling alpha = {alpha}")
    ...
    def _set_cos_sin_cache_power_bowl(
        ...
        - Bernoulli sampled PER TOKEN
        """
        print(f"from power_bowl sampling alpha = {alpha}")
